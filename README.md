#AI-Based Dry Eye Detection System

## Project Overview
This project implements a computer vision–based dry eye detection system using blink rate analysis. 
The system calculates blink rate per minute and classifies ocular health status using predefined clinical thresholds. 
A structured clinical report is automatically generated based on the analysis.
